...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.name'
        db.add_column(u'portal_host', 'name',
                      self.gf('django.db.models.fields.CharField')(default='kd7lxl', max_length=63),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.name'
        db.delete_column(u'portal_host', 'name')
