...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'IPAddress', fields ['ip']
        db.create_unique(u'portal_ipaddress', ['ip'])


    def backwards(self, orm):
        # Removing unique constraint on 'IPAddress', fields ['ip']
        db.delete_unique(u'portal_ipaddress', ['ip'])
