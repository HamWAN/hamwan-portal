...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'portal_ipaddress', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('host', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ipaddresses', to=orm['portal.Host'])),
            ('interface', self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True)),
            ('ip', self.gf('portal.network.IPAddressField')()),
            ('auto_dns', self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'portal', ['IPAddress'])


    def backwards(self, orm):
        # Deleting model 'IPAddress'
        db.delete_table(u'portal_ipaddress')
