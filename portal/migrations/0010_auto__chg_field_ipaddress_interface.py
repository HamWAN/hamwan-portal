...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IPAddress.interface'
        db.alter_column(u'portal_ipaddress', 'interface', self.gf('django.db.models.fields.CharField')(max_length=242, null=True))

    def backwards(self, orm):

        # Changing field 'IPAddress.interface'
        db.alter_column(u'portal_ipaddress', 'interface', self.gf('django.db.models.fields.CharField')(max_length=63, null=True))
