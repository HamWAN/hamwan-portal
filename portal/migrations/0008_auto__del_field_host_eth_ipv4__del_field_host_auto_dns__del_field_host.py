...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Host.eth_ipv4'
        db.delete_column(u'portal_host', 'eth_ipv4')

        # Deleting field 'Host.auto_dns'
        db.delete_column(u'portal_host', 'auto_dns')

        # Deleting field 'Host.wlan_ipv4'
        db.delete_column(u'portal_host', 'wlan_ipv4')


    def backwards(self, orm):
        # Adding field 'Host.eth_ipv4'
        db.add_column(u'portal_host', 'eth_ipv4',
                      self.gf('portal.network.IPAddressField')(null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Host.wlan_ipv4'
        db.add_column(u'portal_host', 'wlan_ipv4',
                      self.gf('portal.network.IPAddressField')(null=True, blank=True),
                      keep_default=False)
