...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.site'
        db.add_column(u'portal_host', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['portal.Site'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.site'
        db.delete_column(u'portal_host', 'site_id')
    ...
    models = {
        ...
        u'portal.host': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['portal.Site']", 'null': 'True', 'blank': 'True'}),
        ...
        u'portal.ipaddress': {
            'Meta': {'ordering': "['ip']", 'object_name': 'IPAddress'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interface': ('django.db.models.fields.CharField', [], {'max_length': '242', 'null': 'True', 'blank': 'True'}),
            'ip': ('portal.network.IPAddressField', [], {'unique': 'True'}),
