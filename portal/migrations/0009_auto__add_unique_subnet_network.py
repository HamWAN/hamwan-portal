...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Subnet', fields ['network']
        db.create_unique(u'portal_subnet', ['network'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subnet', fields ['network']
        db.delete_unique(u'portal_subnet', ['network'])
